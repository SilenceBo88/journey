...
<html lang="en">
 ...
 <div class="panle panel-info">
     <div class="panel-heading">
         <a class="panel-title">添加通知</a>
     </div>
     <div class="container">
         <form class="form-horizontal" action="${APP_PATH }/Notice/add" method="post">
             <div class="form-group form-group-lg">
                 <label for="title" class="col-sm-2 control-label">标题</label>
                 <div class="col-sm-4">
                     <input type="text" class="form-control" id="title" name="notice.title" placeholder="通知标题">
                 </div>
             </div>
             <div class="form-group form-group-lg">
                 <label for="context" class="col-sm-2 control-label">内容</label>
                 <div class="col-sm-4">
                     <input type="text" class="form-control" id="context" name="notice.context" placeholder="通知内容">
                 </div>
             </div>
             <div class="form-group form-group-lg">
